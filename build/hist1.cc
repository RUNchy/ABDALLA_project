...
void hist()
{
	...
	TTree *t10_1 = (TTree*)file->Get("layer10");
	TTree *t10_2 = (TTree*)file->Get("layer10");
	TTree *t10_3 = (TTree*)file->Get("layer10");
			
	TTree *t9 = (TTree*)file->Get("layer9");
	TTree *t9_1 = (TTree*)file->Get("layer9");
	TTree *t9_2 = (TTree*)file->Get("layer9");
	TTree *t9_3 = (TTree*)file->Get("layer9");
	
	TTree *t8 = (TTree*)file->Get("layer8");
	TTree *t8_1 = (TTree*)file->Get("layer8");
	TTree *t8_2 = (TTree*)file->Get("layer8");
	TTree *t8_3 = (TTree*)file->Get("layer8");	

	TTree *t7 = (TTree*)file->Get("layer7");
	TTree *t7_1 = (TTree*)file->Get("layer7");
	TTree *t7_2 = (TTree*)file->Get("layer7");
	TTree *t7_3 = (TTree*)file->Get("layer7");
		
	TTree *t6 = (TTree*)file->Get("layer6");
	TTree *t6_1 = (TTree*)file->Get("layer6");
	TTree *t6_2 = (TTree*)file->Get("layer6");
	TTree *t6_3 = (TTree*)file->Get("layer6");
				
	TTree *t5 = (TTree*)file->Get("layer5");
	TTree *t5_1 = (TTree*)file->Get("layer5");
	TTree *t5_2 = (TTree*)file->Get("layer5");
	TTree *t5_3 = (TTree*)file->Get("layer5");
		
	TTree *t4 = (TTree*)file->Get("layer4");
	TTree *t4_1 = (TTree*)file->Get("layer4");
	TTree *t4_2 = (TTree*)file->Get("layer4");
	TTree *t4_3 = (TTree*)file->Get("layer4");	
	
	TTree *t3 = (TTree*)file->Get("layer3");
	TTree *t3_1 = (TTree*)file->Get("layer3");
	TTree *t3_2 = (TTree*)file->Get("layer3");
	TTree *t3_3 = (TTree*)file->Get("layer3");
	
	TTree *t2 = (TTree*)file->Get("layer2");
	TTree *t2_1 = (TTree*)file->Get("layer2");
	TTree *t2_2 = (TTree*)file->Get("layer2");
	TTree *t2_3 = (TTree*)file->Get("layer2");
	
	TTree *t1 = (TTree*)file->Get("layer1");
	TTree *t1_1 = (TTree*)file->Get("layer1");
	TTree *t1_2 = (TTree*)file->Get("layer1");
	TTree *t1_3 = (TTree*)file->Get("layer1");
	
	//// hitograms for entries ///// 
	TH1F *hist10 =new TH1F("hist10","hist10",1000,0,1000);
	TH1F *hist10_1 =new TH1F("hist10","hist10",1000,0,1000);
	TH1F *hist10_2 =new TH1F("hist10","hist10",1000,0,1000);
	TH1F *hist10_3 =new TH1F("hist10","hist10",1000,0,1000);
		
	TH1F *hist9 =new TH1F("hist9","hist9",1000,0,1000);
	TH1F *hist9_1 =new TH1F("hist9","hist9",1000,0,1000);
	TH1F *hist9_2 =new TH1F("hist9","hist9",1000,0,1000);
	TH1F *hist9_3 =new TH1F("hist9","hist9",1000,0,1000);
	
	TH1F *hist8 =new TH1F("hist8","hist8",1000,0,1000);
	TH1F *hist8_1 =new TH1F("hist8","hist8",1000,0,1000);
	TH1F *hist8_2 =new TH1F("hist8","hist8",1000,0,1000);
	TH1F *hist8_3 =new TH1F("hist8","hist8",1000,0,1000);
	
	TH1F *hist7 =new TH1F("hist7","hist7",1000,0,1000);
	TH1F *hist7_1 =new TH1F("hist7","hist7",1000,0,1000);
	TH1F *hist7_2 =new TH1F("hist7","hist7",1000,0,1000);
	TH1F *hist7_3 =new TH1F("hist7","hist7",1000,0,1000);
	
	TH1F *hist6 =new TH1F("hist6","hist6",1000,0,1000);
	TH1F *hist6_1 =new TH1F("hist6","hist6",1000,0,1000);
	TH1F *hist6_2 =new TH1F("hist6","hist6",1000,0,1000);
	TH1F *hist6_3 =new TH1F("hist6","hist6",1000,0,1000);
	
	TH1F *hist5 =new TH1F("hist5","hist5",1000,0,1000);
	TH1F *hist5_1 =new TH1F("hist5","hist5",1000,0,1000);
	TH1F *hist5_2 =new TH1F("hist5","hist5",1000,0,1000);
	TH1F *hist5_3 =new TH1F("hist5","hist5",1000,0,1000);
	
	TH1F *hist4 =new TH1F("hist4","hist4",1000,0,1000);
	TH1F *hist4_1 =new TH1F("hist4","hist4",1000,0,1000);
	TH1F *hist4_2 =new TH1F("hist4","hist4",1000,0,1000);
	TH1F *hist4_3 =new TH1F("hist4","hist4",1000,0,1000);
	
	TH1F *hist3 =new TH1F("hist3","hist3",1000,0,1000);
	TH1F *hist3_1 =new TH1F("hist3","hist3",1000,0,1000);
	TH1F *hist3_2 =new TH1F("hist3","hist3",1000,0,1000);
	TH1F *hist3_3 =new TH1F("hist3","hist3",1000,0,1000);
	
	TH1F *hist2 =new TH1F("hist2","hist2",1000,0,1000);
	TH1F *hist2_1 =new TH1F("hist2","hist2",1000,0,1000);
	TH1F *hist2_2 =new TH1F("hist2","hist2",1000,0,1000);
	TH1F *hist2_3 =new TH1F("hist2","hist2",1000,0,1000);
	
	TH1F *hist1=new TH1F("hist1","hist1",1000,0,1000);
	TH1F *hist1_1=new TH1F("hist1","hist1",1000,0,1000);
	TH1F *hist1_2=new TH1F("hist1","hist1",1000,0,1000);
	TH1F *hist1_3=new TH1F("hist1","hist1",1000,0,1000);
...
vector<double> fX_10,fX_9,fX_8,fX_7,fX_6,fX_5,fX_4,fX_3,fX_2,fX_1 ;
	...
	auto ang=new TH1F("hist","hist",10,30,120);
